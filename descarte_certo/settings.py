...
SECRET_KEY = 'django-insecure-luvzzy67=g-4$a0$=)%1r@=6i)ep5v_mx)##!xe2ayp_a5qf-t'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'descarte_certo',
        'USER': 'descarte_admin',
        'PASSWORD': 'descarte_certo_2026', # Usem essa mesma senha quando criarem o banco de dados
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
